...
\begin{enumerate}
  ...
  \item The modal presents the LO text and module descriptor at the top, then
  solicits a score (0--3) and optional rationale for each of D1, D4, D5, and D6.
  Score buttons are colour-coded (red/orange/green/blue for 0/1/2/3) and labelled
  with the rubric descriptor for that score.
